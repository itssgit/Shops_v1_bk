...
function() {
    ...
    function a(a, b, c) {
        ...
        a.events = [{
            title: "All Day Event",
            start: new Date(g, f, 1)
        }, {
            title: "Long Event",
            start: new Date(g, f, e - 5),
            end: new Date(g, f, e - 2)
        }, {
            title: "Go Hiking",
            start: new Date(g, f, e - 1),
            className: ["fc-event-warning"]
        }, {
            id: 999,
            title: "Repeating Event",
            start: new Date(g, f, e - 3, 16, 0),
            allDay: !1,
            className: ["fc-event-success"]
        }, {
            id: 999,
            title: "Repeating Event",
            start: new Date(g, f, e + 4, 16, 0),
            allDay: !1,
            className: ["fc-event-success"]
        }, {
            title: "Birthday Party",
            start: new Date(g, f, e + 1, 11, 0),
            end: new Date(g, f, e + 1, 12, 30),
            allDay: !1,
            className: ["fc-event-danger"]
        }, {
            title: "Shopping",
            start: new Date(g, f, e + 2, 9, 0),
            end: new Date(g, f, e + 2, 12, 0),
            allDay: !1,
            className: ["fc-event-success"]
        }, {
            title: "Click for Google",
            start: new Date(g, f, 28),
            end: new Date(g, f, 29),
            url: "http://google.com/"
        }, {
            title: "Shopping",
            start: new Date(g, f + 1, 8)
            ...
            events: [{
                type: "party",
                title: "Lunch",
                start: new Date(g, f, e, 12, 0),
                end: new Date(g, f, e, 14, 0),
                allDay: !1
            }, {
                type: "party",
                title: "Lunch 2",
            ...
            a.events.push({
                title: "New Event",
                start: new Date(g, f, e),
                end: new Date(g, f, e + 1)
            })
        }, a.remove = function(b) {
            a.events.splice(b, 1)
        }, a.changeView = function(a, b) {
            c.calendars[b].fullCalendar("changeView", a)
    ...
    angular.module("app.calendar").controller("calendarCtrl", ["$scope", "$compile", "uiCalendarConfig", a])
}(),
function() {
    "use strict";
...
function() {
    ...
    function a(a, b) {
        ...
        function d() {
            for (var a = [], b = 100; b--;) a.push([c(), c(), Math.abs(c())]);
            return a
        }
...
function() {
    ...
    function b(a) {
        a.today = function() {
            ...
            formatYear: "yy",
            startingDay: 1
        }, a.formats = ["dd-MMMM-yyyy", "yyyy/MM/dd", "dd.MM.yyyy", "shortDate"], a.format = a.formats[0], a.altInputFormats = ["M!/d!/yyyy"], a.popup1 = {
            opened: !1
        }, a.popup2 = {
            opened: !1
        };
        ...
        c.setDate(b.getDate() + 1), a.events = [{
            ...
            if ("day" === c)
                for (var d = new Date(b).setHours(0, 0, 0, 0), e = 0; e < a.events.length; e++) {
                    ...
                    if (d === f) return a.events[e].status
                }
            return ""
        }
    }
